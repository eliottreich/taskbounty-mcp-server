...
async function deviceLogin(clientName: string, existingStart?: DeviceStart): Promise<ToolResult> {
...
server.setRequestHandler(CallToolRequestSchema, async (req) => {
  ...
  switch (name) {
    case "taskbounty_login": {
      ...
      // Kick off device flow, then delegate to the shared polling function.
      ...
      return await deviceLogin(clientName, start ?? undefined);
    }
